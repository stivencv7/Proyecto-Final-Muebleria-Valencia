...
export class DataTableEditProducts extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            products1: [
                {"code": "1","name": "Cama","description": "Matrimonial" , "price" : 1000000},
                {"code": "2","name": "Mueble de sala","description": "Comodo" , "price" : 500000}
            ],
            editingRows: {}
        };
        ...
        return (
            <div className="datatable-editing-demo">
                ...
                <div className="card p-fluid">
                    ...
                    <DataTable value={this.state.products1} editMode="row" dataKey="id"  onRowEditComplete={this.onRowEditComplete1} responsiveLayout="scroll">
                        <Column field="code" header="Codigo" editor={(options) => this.textEditor(options)} style={{ width: '20%' }}></Column>
                        <Column field="name" header="Nombre" editor={(options) => this.textEditor(options)} style={{ width: '20%' }}></Column>
                        <Column field="description" header="Descripcion" editor={(options) => this.textEditor(options)} style={{ width: '20%' }}></Column>
                        <Column field="price" header="Precio" editor={(options) => this.textEditor(options)} style={{ width: '20%' }}></Column>
